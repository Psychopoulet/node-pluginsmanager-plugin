...
export function checkNonEmptyStringSync (dataName: string, data: unknown): ReferenceError | TypeError | RangeError | null {
...
export function checkNonEmptyString (dataName: string, data: unknown): Promise<void> {
