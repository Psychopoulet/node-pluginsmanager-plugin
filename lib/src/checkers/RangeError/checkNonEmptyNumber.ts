...
export function checkNonEmptyNumberSync (dataName: string, data: unknown): ReferenceError | TypeError | RangeError | null {
...
export function checkNonEmptyNumber (dataName: string, data: unknown): Promise<void> {
