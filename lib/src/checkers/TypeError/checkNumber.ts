...
export function checkNumberSync (dataName: string, data: unknown): ReferenceError | TypeError | null {
...
export function checkNumber (dataName: string, data: unknown): Promise<void> {
