    ...
    appMiddleware(_req, res, next) {
        ...
        this.checkDescriptor().then(() => {
            ...
            if ("/" + this._Descriptor.info.title + "/api/descriptor" === req.pattern && "get" === req.method) {
                // add current server
                const port = (_d = (_c = res.socket) === null || _c === void 0 ? void 0 : _c.localPort) !== null && _d !== void 0 ? _d : ((_e = res.socket) === null || _e === void 0 ? void 0 : _e.address()).port;
            ...
            switch (serverType) {
                case "WEBSOCKET":
                    this._socketServer.clients.forEach((client) => {
                        var _a;
                        (_a = client.id) !== null && _a !== void 0 ? _a : (client.id = (0, uniqid_1.default)());
        ...
        switch (this._serverType()) {
            case "WEBSOCKET": {
                ...
                this._socketServer.clients.forEach((s) => {
                    var _a;
                    (_a = s.id) !== null && _a !== void 0 ? _a : (s.id = (0, uniqid_1.default)());
                    result.push({
                        "id": s.id,
