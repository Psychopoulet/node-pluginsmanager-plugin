    ...
    appMiddleware(req, res, next) {
        ...
        this.checkDescriptor().then(() => {
            ...
            if ("/" + this._Descriptor.info.title + "/api/descriptor" === req.pattern && "get" === req.method) {
                ...
                return (0, send_1.default)(req, res, serverCodes_1.default.OK, this._Descriptor, {
            ...
            // get plugin status
                ...
                return (0, send_1.default)(req, res, serverCodes_1.default.OK, status, {
                    "apiVersion": apiVersion,
                    "cors": this._cors,
                    "mime": "application/json; charset=utf-8"
                });
            ...
            // no "Content-Length" header found
                ...
                return Promise.resolve().then(() => {
                    ...
                    const mime = (0, extractMime_1.default)(req, serverCodes_1.default.OK_PUT, responses);
                    // created
                    if ("put" === req.method) {
                        if ("undefined" === typeof content || null === content) {
                            this._log("success", "<= [" + req.validatedIp + "] no content");
                            return (0, send_1.default)(req, res, serverCodes_1.default.OK_PUT, undefined, {
                                "apiVersion": apiVersion,
                                "cors": this._cors,
                                "mime": mime
                            });
                    ...
                    // no content
                        ...
                        return (0, send_1.default)(req, res, serverCodes_1.default.OK_NO_CONTENT, undefined, {
                            "apiVersion": apiVersion,
                            "cors": this._cors,
                            "mime": mime
                        });
