...
function send(req, res, code, content, options) {
    return Promise.resolve().then(() => {
        ...
        return new Promise((resolve) => {
            ...
            var _a, _b;
            res.statusCode = code;
            res.headers = Object.assign({ "Content-Type": options.mime, "Content-Length": 0 < formattedContent.length ? Buffer.byteLength(formattedContent) : 0, "Status-Code-Url-Cat": "https://http.cat/" + code, "API-Version": options.apiVersion }, options.cors ? {
                "Access-Control-Allow-Origin": "*",
                "Access-Control-Allow-Credentials": true,
                "Access-Control-Allow-Methods": (_a = req.headers["access-control-request-method"]) !== null && _a !== void 0 ? _a : [
                    "GET",
                    "POST",
                    "PUT",
                    "DELETE",
                ...
                "Access-Control-Allow-Headers": (_b = req.headers["access-control-request-headers"]) !== null && _b !== void 0 ? _b : [
                    "Origin",
                    "Accept",
                    "Accept-Version",
                    "Content-Length",
