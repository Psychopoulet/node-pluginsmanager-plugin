...
// deps
	...
	// locals
		...
		const requiredProperty = require(join(
			...
			"pathsParameters", "parametersDescription", "requiredProperty.js"
		));

// tests

describe("DescriptorUser / checkDescriptor / pathsParameters / parametersDescription / requiredProperty", () => {
